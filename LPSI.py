...
data_name = 'digg16000'  # 'karate','dolphins','jazz','netscience','cora_ml', 'power_grid',,'meme7000','digg16000'
...
train_ratio = 0.6
train_num = int(len(dataset["diff_mat"])*train_ratio)
diff_mat = copy.copy(dataset['diff_mat'])
train_auc = 0
test_auc = 0
alpha = 0.01
